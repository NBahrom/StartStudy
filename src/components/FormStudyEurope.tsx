            ...
            <div className="container-wide">
                <div className={styles.section8Inner}>
                    ...
                    <div className={`${styles.section8Text} section-text-2`}>
                        Пожалуйста укажите вашу контактную информацию в форме ниже. Наш менеджер
                        свяжется с вами в ближайшее время и ответит на все ваши вопросы.
                    </div>

                    <form ref={formRef} className={styles.mainForm} onSubmit={handleSubmit} id="main-form">
                        <input
                        ...
                        <div ref={successMsg} className={`${styles.mainFormSuccess} ${styles.hidden}`}>
